...
<html>
    <head>
        ...
        <title>Summary for ${conceptsInstance?.name}</title>
    ...
    <body>
        <div id="show-concepts" class="content scaffold-show" role="main">	       
	            <div id ="title" style="width: 676px; height: ${height};float:left;">
	             <h1>Concept Information</h1>
	            <div style="width:${width}; height: 220px;float:left ;">
		            <ol class="property-list concepts">	            
		                ...
		                <li class="fieldcontain">
		                    ...
		                    <g:set var="cnm" value="${conceptsInstance?.id}"/>    
		                    <span class="property-value" aria-labelledby="num_compounds-label"> <g:fieldValue bean="${conceptsInstance}" field="num_compounds" target="_blank"/> <g:link controller="Compounds_in_concepts" action="findComp" params="[q:cnm]">	<span class="text" STYLE="font-size: 10pt"> [View Compounds]</span></g:link></span>
		                </li> 
		                </g:if>
		            </ol>
	            </div>
	           
		        <div style="width: 80px; height: 200px;float:left ;border = 1">
		            <br/><br/>		         
	            ...
	            <div id ="title" style="width: 250px; height:${height}; float:right ; ">  
